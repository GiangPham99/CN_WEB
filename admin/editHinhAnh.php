...
<?php
    ...
    <form class="row g-3 needs-validation" action="" method="POST">
        ...
        <div class="col-md-6">
            <label for="validationCustomUsername" class="form-label">Ngày đăng</label>
            <input type="text" class="form-control" name="ngaydang" placeholder="Họ tên" value="<?php echo $row['ngaydang'];?>" required>
        </div>
        <?php
                }               
            ?>
