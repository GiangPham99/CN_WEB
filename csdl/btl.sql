...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 29, 2021 at 11:53 AM
...
--
ALTER TABLE `thuvien`
  MODIFY `idhinhanh` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tintuc`
--
ALTER TABLE `tintuc`
  MODIFY `idtintuc` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
